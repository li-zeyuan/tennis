...
var fileDescriptor_d8d3c606fb107336 = []byte{
	...
	0x93, 0x53, 0x25, 0x98, 0x14, 0x18, 0x35, 0x98, 0x83, 0x20, 0x1c, 0x23, 0x63, 0x2e, 0x56, 0x67,
	0x90, 0x46, 0x21, 0x2d, 0x2e, 0x88, 0x55, 0x42, 0xfc, 0x7a, 0x10, 0xfb, 0x61, 0xf6, 0x49, 0x09,
	0xa0, 0x0a, 0x14, 0x17, 0x24, 0xb1, 0x81, 0xdd, 0x66, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x51,
	0x6e, 0x1e, 0xbd, 0xaa, 0x00, 0x00, 0x00,
}
...
func (c *checkClient) Check(ctx context.Context, in *CheckReq, opts ...grpc.CallOption) (*CheckResp, error) {
	out := new(CheckResp)
	err := c.cc.Invoke(ctx, "/check.Check/check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCheckServer) Check(ctx context.Context, req *CheckReq) (*CheckResp, error) {
...
func _Check_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/check.Check/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckServer).Check(ctx, req.(*CheckReq))
	}
